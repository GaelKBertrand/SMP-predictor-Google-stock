...
## For the following steps, you can just refer to the notebook file. The next processes involve collecting data, training, testing, and collecting performance metrics. The steps are ordered as following: 
